...
随附 CLI 可以绑定所有接口，并为信任栅栏派生 LAN authority。认证不提供 TLS、转发 header 解释或代理配置；[账号密码决策](../feature/2026-09-06-account-password-browser-authentication.zh.md)持有网络登录凭据路径及其引导要求。
